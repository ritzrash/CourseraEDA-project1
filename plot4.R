...
par(mfrow = c(2,2))
with(df_subset,{
  plot(df_subset$Time,df_subset$Global_active_power, type="l", xlab="", ylab="Global Active Power")  
  plot(df_subset$Time,df_subset$Voltage, type="l",xlab="datetime",ylab="Voltage")
  ...
  plot(df_subset$Time,df_subset$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
})
